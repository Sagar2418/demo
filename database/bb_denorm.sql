...
-- Database: `blood_bank`
--
CREATE DATABASE IF NOT EXISTS `bb_denorm` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bb_denorm`;
...
--
-- Table structure for table `person_donation_receive`
--

CREATE TABLE `person_donation_receive` (
...
--
-- Indexes for table `person_donation_receive`
--
ALTER TABLE `person_donation_receive`
...
--
-- AUTO_INCREMENT for table `person_donation_receive`
--
ALTER TABLE `person_donation_receive`
